...
# Módulo RDS
mkdir -p $TEMP_DIR/iac/terraform/modules/rds
...
# Módulo DynamoDB
mkdir -p $TEMP_DIR/iac/terraform/modules/dynamodb
...
# Módulo S3
mkdir -p $TEMP_DIR/iac/terraform/modules/s3
...
# Módulo EKS
mkdir -p $TEMP_DIR/iac/terraform/modules/eks
...
# Script de migración — se crea ANTES del chmod
...
# chmod DESPUÉS de que el archivo existe
...
echo "  grep -r \"123456789\" --include=\"*.tf\" --include=\"*.yaml\" --include=\"*.md\" $PROJECT_DIR"